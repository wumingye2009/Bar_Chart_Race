...
# =========================
# 定义工具函数：在 DataFrame 的列中寻找“候选里第一个存在的列名”。找不到返回 None。
# =========================
...
def main():
    ...
    # 5) Downsample years (every N years, depends on INTERVAL_YEARS setting above) + always include the latest year
    if INTERVAL_YEARS > 1:
